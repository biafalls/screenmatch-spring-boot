...
public class Principal {
    ...
    private final String CHAVE_API = "&apikey=ae8def4d";

    public void exibirMenu() {
        System.out.println("Digite o nome da série que deseja assistir: ");
        var nomeSerie = scanner.nextLine();

        var json = consumo.obterDados(ENDERECO + nomeSerie.replace(" ", "+") + CHAVE_API);
        ...
        for (int i =1; i <= dadosSerie.totalTemporadas(); i++) {
            json = consumo.obterDados(ENDERECO + nomeSerie.replace(" ", "+") + "&season=" + i +CHAVE_API);
...
//        System.out.println("A partir de que ano você deseja ver os episorios?");
...
//                                " Data de Lançaamento: " + e.getDataLancamento().format(formatador)
//                ));
        ...
        System.out.println("Quentidade: " + est.getCount());
    }
}
